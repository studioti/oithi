    ...
    return (
        <section className={scss.footer} id='footer'>
                    ...
                    <Col xs={12} lg={6} className={scss.right}>
                        <Row className={scss.contact}>
                            <Col xs={12} className={scss.address}>
                                <div className={scss.box} role="heading" aria-level={2}>
                                    <span>SÃO PAULO / SP • BRASIL</span>
                                </div>
                            </Col>
                            <Col xs={12} className={scss.cta}>
                                <div className={scss.box}>
                                    <Link href='mailto:thiago.aguiar86@gmail.com'>
                                        <span>CALL ME !!!</span>
                                    </Link>
                                    <picture>
                                        <source	srcSet={'/bg-cta-footer.webp'} type="image/webp"></source>
                                        <img src={'/bg-cta-footer.png'} alt={'Call me'} title={'Call me'} aria-label={'Call me'}></img>
                                    </picture>
                                </div>
                            </Col>
                        </Row>
            ...
            <div className={scss.coffee}>
                <p>
                    Vamos tomar um <span role="heading" aria-level={2}>café?</span>
